      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-surface-container-lowest/20 shadow-2xl mb-4 relative flex items-center justify-center bg-primary-container">
          {user.avatar_url ? (
            ...
            <span className="text-on-primary font-bold text-3xl">
        ...
        <Link
          ...
          className="mt-6 px-6 py-3 bg-surface-container-lowest text-primary font-bold rounded-xl text-sm hover:scale-[1.03] active:scale-[0.97] transition-transform shadow-lg"
        >
          {t("edit_profile")}
        </Link>
      </div>
