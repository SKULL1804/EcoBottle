...
export default function EnvironmentalImpact() {
  ...
  return (
    <div className="bg-linear-to-br from-on-primary-container to-primary rounded-2xl p-8 text-on-primary shadow-xl relative overflow-hidden h-full flex flex-col justify-center">
