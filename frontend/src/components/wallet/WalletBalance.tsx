  ...
  return (
    <div className="bg-linear-to-br from-on-primary-container to-primary rounded-2xl p-6 md:p-8 text-on-primary shadow-xl relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="flex items-center justify-between mb-5 md:mb-6">
          <div className="flex items-center gap-3">
            <div className="p-2.5 bg-surface-container-lowest/15 rounded-xl backdrop-blur-sm flex items-center justify-center">
              <span className="material-symbols-outlined text-xl md:text-2xl" style={{ fontVariationSettings: '"FILL" 1' }}>account_balance_wallet</span>
            </div>
            <div>
        ...
        <h2 className="text-3xl md:text-5xl font-black font-headline tracking-tighter mb-6 md:mb-8">
          Rp {Number(balance).toLocaleString("id")}
        </h2>

        <div className="grid grid-cols-2 gap-3">
          <Link href="/dashboard/withdraw" className="py-2.5 md:py-3 bg-surface-container-lowest text-primary font-bold rounded-xl text-sm hover:scale-[1.03] active:scale-[0.97] transition-transform shadow-lg text-center flex items-center justify-center gap-2">
            <span className="material-symbols-outlined text-lg">payments</span>
            {t("withdraw")}
          </Link>
          <Link href="/dashboard/history" className="py-2.5 md:py-3 bg-surface-container-lowest/15 backdrop-blur-sm text-on-primary font-bold rounded-xl text-sm hover:bg-surface-container-lowest/25 transition-all text-center flex items-center justify-center gap-2">
