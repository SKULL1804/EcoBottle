...
export default function ImpactSection() {
  return (
    <section id="impact" className="max-w-7xl mx-auto px-8 py-20 relative z-10">
      <div className="bg-surface-container-lowest border border-outline-variant/30 rounded-[3rem] p-16 shadow-[0px_24px_48px_rgba(17,28,45,0.06)] relative overflow-hidden group">
          ...
          {IMPACT_STATS.map((stat) => (
            <div key={stat.label}>
              <div key={stat.label} className="py-6 md:py-0 md:px-6 transition-transform duration-500 hover:scale-110">
                <div className="text-6xl md:text-7xl font-extrabold font-headline mb-4 bg-linear-to-br from-primary to-on-primary-container bg-clip-text text-transparent drop-shadow-sm">
                  {stat.value}
                </div>
